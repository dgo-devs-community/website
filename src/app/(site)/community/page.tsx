    ...
    <>
      ...
      <div className="max-w-6xl mx-auto py-12 md:py-8">
        <div className="bg-blue-900 text-white rounded-lg p-8 text-center items-center flex flex-col gap-4">
            <h3 className="text-2xl font-bold">¿Quieres ser parte de nuestra comunidad?</h3>
            <p className="max-w-2xl mx-auto">
            Únete a nosotros y forma parte de un grupo de personas apasionadas por la tecnología que comparten
            conocimientos, experiencias y oportunidades.
            </p>
            <Button className="bg-white w-fit text-blue-900 hover:bg-gray-100 px-8 py-6 text-lg" asChild>
                <Link
                 href={"https://discord.gg/G4RsQJwuP8"}
                 target="_blank"
                >
                    Unetenos ahora
                </Link>
