...
export default function Home() {
  return (
    <>
      ...
      {/* Promocional de la fiesta - only show if party info is enabled */}
      {shouldShowPartyInfo() && <PartyPromo />}

      {/* Medidor de progreso del evento - only show if both features are enabled */}
      ...
      <div className="md:max-w-6xl md:mx-auto md:grid md:grid-cols-12 md:gap-8 md:py-12 md:px-0">
        ...
        <div className="md:col-span-5 space-y-6">
          {/* Feed de actividad en vivo - only show if both features are enabled */}
          {shouldShowTicketGoals() && shouldShowPartyInfo() && (
