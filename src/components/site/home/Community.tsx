...
export default function Community() {
  return (
    <section
      id="comunidad"
      className="bg-gray-50 p-6 md:bg-transparent text-inherit md:p-0 md:mb-12"
    >
      ...
      <p className="mb-4 md:text-lg opacity-90 md:opacity-100 md:text-gray-700">
        Bienvenido a nuestra comunidad tech: un espacio donde desarrolladores,
      ...
      <p className="mb-6 md:mb-8 md:text-lg opacity-90 md:opacity-100 md:text-gray-700">
        Explora nuevas oportunidades, aprende de expertos y sé parte de un
        movimiento en constante crecimiento.
      </p>
