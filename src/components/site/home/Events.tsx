  ...
  return (
    ...
    >
      ...
      <p className="mb-6 md:text-lg opacity-90 md:opacity-100 md:text-gray-700">
        Participa en los eventos de nuestra comunidad: desde talleres prácticos y charlas inspiradoras hasta sesiones de
        networking que potencian tus mentes creativas.
      </p>
      <p className="mb-6 md:text-lg opacity-90 md:opacity-100 md:text-gray-700">
        Descubre lo último en tecnología, diseño y marketing mientras colaboras con profesionales que comparten tu
        pasión.
      </p>
